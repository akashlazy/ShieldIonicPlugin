...
// const ShieldConfig = require("../../../ShieldFraudPlugin/www/shield_config");
...
function onDeviceReady() {
    ...
    config["siteID"] = "dda05c5ddac400e1c133a360e2714aada4cda052";
    config["key"] = "9ce44f88a25272b6d9cbb430ebbcfcf1";
    config["registerCallback"] = true;
    ...
    function getDeviceResult() {
        ...
        ShieldFraudPlugin.sendDeviceSignature("IONIC Screen", function success(message) {
            console.log("sendDeviceSignature Callback:", message);
        })
    }
    
    // call the function after a 5-second delay
    setTimeout(getDeviceResult, 5000);
